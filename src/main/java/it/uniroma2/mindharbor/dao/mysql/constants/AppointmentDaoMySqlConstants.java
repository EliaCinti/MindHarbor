...
public class AppointmentDaoMySqlConstants {
    ...
    public static final String ERROR_UPDATING_APPOINTMENT_NOTIFICATION_STATUSES = "Error updating appointment notification status ";
    public static final String ERROR_RESETTING_AUTO_COMMIT = "Error resetting auto commit ";
    public static final String FAILED_TO_OBTAIN_DATABASE_CONNECTION = "Failed to obtain database connection ";
